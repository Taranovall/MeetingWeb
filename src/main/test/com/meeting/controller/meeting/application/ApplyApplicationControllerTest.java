...
class ApplyApplicationControllerTest {

    private ApplyApplicationController applyApplicationController;
    @Mock
    ...
    void setUp() {
        ...
        applyApplicationController = new ApplyApplicationController();
    ...
    void tearDown() throws Exception {
        closeable.close();
        applyApplicationController = null;
        session = null;
        req = null;
        resp = null;
    }
    ...
    @Test
    void shouldApplyApplication() throws IOException, ServletException {
        User userWithRoleSpeaker = createUserWithRoleSpeaker();

        applyApplicationController.setSpeakerService(speakerService);
        ...
        applyApplicationController.doPost(req, resp);
