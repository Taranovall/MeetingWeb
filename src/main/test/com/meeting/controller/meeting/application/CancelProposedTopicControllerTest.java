...
class CancelProposedTopicControllerTest {
    ...
    private CancelProposedTopicController cancelProposedTopicController;
    @Mock
    ...
    void setUp() {
        ...
        cancelProposedTopicController = new CancelProposedTopicController();
    ...
    void tearDown() throws Exception {
        closeable.close();
        cancelProposedTopicController = null;
        session = null;
        meetingService = null;
        req = null;
        resp = null;
