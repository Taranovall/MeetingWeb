        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" ><fmt:message key="signInMenu.authorization"/></h5>
                </div>
                <div class="modal-body text-center" style="padding-bottom: 0">
                    ...
                    <button type="submit" class="btn btn-outline-dark mb-2"><fmt:message key="signInMenu.signInButton"/></button>
                </div>
                <div class="modal-footer justify-content-center">
                    <a class="btn" href="registration"><u><fmt:message key="signInMenu.noAccount"/></u></a>
                </div>
            </div>
        </div>
    </form>
