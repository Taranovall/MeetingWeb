...
<div class="container mt-5 mb-5 text-center">
    ...
    <form action="/moderator/create-meeting" method="get" class="add">
        ...
        <div class="field">
            <input type="text" name="date" class="form-control" placeholder="<fmt:message key="meeting.date_placeholder"/>"
        ...
        <div class="field">
            <div class="input-group field mt-0">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="inputStartTime"><fmt:message key="meeting.start_time"/></span>
                    </div>
                    <input type="time" name="startTime" class="form-control" aria-describedby="inputStartTime">
                    <div class="input-group-prepend ml-2">
                        <span class="input-group-text" id="basic-inputEndTime"><fmt:message key="meeting.end_time"/></span>
                    </div>
        ...
        <%-- count of topics --%>
        <div class="field">
            <input type="text" name="countOfTopics" placeholder="<fmt:message key="meeting.count_of_topics"/>" class="form-control">
        </div>
